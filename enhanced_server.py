...
"""
УЛУЧШЕННЫЙ СЕРВЕР
С корзиной, фотографиями и полным API
"""
...
products = [
    ...
    },
    {
        ...
        "image": "/static/images/sneakers.jpg", 
        "active": True
    },
    {
        "id": 4, 
            ...
            for i, product in enumerate(products):
                if product['id'] == product_id:
                    products[i] = {
                        ...
                        "image": data.get('image', product.get('image', '/static/images/default.jpg')),
...
{html_content}"""
    ...
    # Админ панель
        ...
        try:
            with open('enhanced_admin.html', 'r', encoding='utf-8') as f:
                html_content = f.read()
        except FileNotFoundError:
...
def start_server():
    ...
    print(f"🌐 Улучшенный сервер запущен на http://localhost:{PORT}")
