...
# -*- coding: utf-8 -*-
"""
СЕРВЕР С ФОТОГРАФИЯМИ И ИСПРАВЛЕННЫМ ДОБАВЛЕНИЕМ
"""
...
<html><head><title>Магазин с Фотографиями</title></head>
<body style="background:#000;color:#fff;font-family:Arial;margin:0;padding:15px;">
<h1 style="text-align:center;margin-bottom:20px;">🛍️ Магазин с Фотографиями</h1>
...
def start_server():
    ...
    print(f"🌐 Сервер с фотографиями запущен на http://localhost:{PORT}")
    print(f"📱 Магазин: http://localhost:{PORT}")
    print(f"📷 Фотографии сохраняются в папку: {UPLOADS_DIR}")
