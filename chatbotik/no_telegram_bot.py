...
def handle_webapp_order(user_id, web_app_data):
    ...
    try:
        ...
        if order_data.get('action') == 'order' or order_data.get('type') == 'order':
            ...
            # Уведомляем клиента - красивое подтверждение
            client_message = (
                f"╔═══════════════════════════════════╗\n"
                f"║     ✅ <b>ЗАКАЗ ПРИНЯТ!</b>            ║\n"
                f"╚═══════════════════════════════════╝\n\n"
                ...
                f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
                f"🏦 <b>СБП</b> (Система Быстрых Платежей)\n"
                f"   ✅ Без комиссии!\n"
                ...
                f"📱 <b>ЧТО ДАЛЬШЕ?</b>\n"
                f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
                f"1️⃣ Администратор свяжется с вами\n"
                f"2️⃣ Согласуем детали доставки\n"
                f"3️⃣ Выберете способ оплаты\n"
                f"4️⃣ Получите ваш заказ!\n\n"
                f"📞 <b>КОНТАКТЫ</b>\n"
                f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
                f"💬 Вопросы? Просто напишите в чат!\n"
                f"📋 История: /myorders\n\n"
                f"╔═══════════════════════════════════╗\n"
            ...
            for admin_id in admins_from_db:
                try:
                    # Красивый шаблон сообщения о заказе
                    admin_message = (
                        f"╔═══════════════════════════════════╗\n"
                        f"║      🛍️ <b>НОВЫЙ ЗАКАЗ!</b>            ║\n"
                        f"╚═══════════════════════════════════╝\n\n"
                        ...
                        f"💳 Перевод на карту\n\n"
                        f"╔═══════════════════════════════════╗\n"
                        f"║  ✅ Обработайте заказ в течение   ║\n"
                        f"║     30 минут для лучшего сервиса  ║\n"
                        f"╚═══════════════════════════════════╝"
                    )
