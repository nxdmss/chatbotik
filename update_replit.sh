...
# Восстанавливаем только если БД пустая или нет активных товаров
if [ ! -f "shop.db" ] || [ "$PRODUCT_COUNT" -eq 0 ]; then
    echo "⚠️ База данных пустая или нет активных товаров!"
    echo "📦 Принудительно восстанавливаем базу данных..."
    
    # Используем принудительное восстановление
    python3 force_restore.py
    
    if [ $? -eq 0 ]; then
        echo "✅ База данных восстановлена"
    else
        echo "⚠️ Ошибка восстановления"
    fi
else
